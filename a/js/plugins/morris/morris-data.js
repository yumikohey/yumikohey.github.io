$(function(){
	Morris.Donut({
	  element: 'total_cpu',
	  data: [
	    {label: "Available CPU", value: 86},
	    {label: "In use CPU", value: 14}
	  ],
	...
	Morris.Donut({
	  element: 'total_ram',
	  data: [
	    {label: "Total RAM", value: 100},
	    {label: "In use RAM", value: 20}
	  ],
	  formatter: function(y, data){
	  	return y + 'GB'
	  },
	...
	Morris.Donut({
	  ...
	  data: [
	    {label: "Available Capacity", value: 495},
	    {label: "Used Capacity", value: 0}
	  ],
	  formatter: function(y, data){
	  	return y + 'GB'
	  },
